...
class FullPostFrame(ScrollFrame, DarkMode):
    def __init__(self, master, database_response, current_user, like_command, edit_command, delete_command,
        ...
        self.boardroom_frame = BoardroomFrame(self.frame, database_response["post_title"],
                                              ...
                                              delete_command, reply_command, database_response["post_views"],
        ...
        for reply in database_response["post_replies"]:
            ...
            reply_frame = ReplyFrame(self.frame, reply["reply_text"], like_command, edit_command, delete_command,
                                     reply["reply_likes"], replier, reply["reply_time"], reply["reply_id"],
                                     self.boardroom_frame.post_id, reply["reply_is_edited"],
