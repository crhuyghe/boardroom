...
class HomeFrame(ttk.Frame):
    ...
    def __init__(self, master=None, dark_mode=False):
        ...
        search_frame = ttk.Frame(self.master, borderwidth=2, relief="solid")
        ...
        search_button = FlatButton(search_frame, dark_mode=False, text="Search", font=default_font,
                                   command=lambda: self.search)
        search_button.grid(row=0, column=1, sticky="ew")

        # Create and pack the right column
        right_column_frame = ttk.Frame(self.master, style="TFrame", width=self.master.winfo_screenwidth() // 4,
        ...
        logout_button = FlatButton(right_column_frame, dark_mode=False, text="Logout", font=default_font,
                                   command=lambda: self.logout)
        logout_button.grid(row=0, column=0, sticky="e")

        # Create and pack the welcome frame
        welcome_frame = ttk.Frame(self.master, borderwidth="20", relief="solid")
        ...
        self.master.columnconfigure(0, weight=3)  # 75% screen width
        self.master.columnconfigure(1, weight=1)  # 25% screen width
